...
![Netflix logo](https://github.com/Nagadevaraj04/netflix_sql_project/blob/main/netflix_logo.png)
## Overview
...
```
**Objective:** Count movies with 'Salman Khan' released in the last 10 years.
...
GROUP BY 1;
```
**Objective:** Categorize content as 'Bad' if it contains 'kill' or 'violence' and 'Good' otherwise, then count the number of items in each category.
...
2. Import the `netflix.csv` dataset into your PostgreSQL database using the provided schema.
3. Run the queries in `Netflix_Movies_and_TV_shows_Data_analysis.sql` to explore the business problems and their solutions.
